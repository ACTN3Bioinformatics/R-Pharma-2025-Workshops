...
-   [Bayesian Survival Models](bayesian-survival.qmd) - Applied Stan usage
-   [rpact Trial Design](rpact-trial-design.qmd) - Frequentist alternative

### Related Presentations

-   [BayesERtools](../presentations/europe-us-sessions.qmd#bayesertools-bayesian-exposure-response-analysis) - Production Bayesian package

### Next Steps

-   **Apply skills:** [Bayesian Survival workshop](bayesian-survival.qmd)
-   **Career path:** [Bayesian Methods expertise](../summary/career-insights.qmd#5-bayesian-methods)
