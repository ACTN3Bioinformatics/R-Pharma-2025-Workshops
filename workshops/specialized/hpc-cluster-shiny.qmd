...
### Similar Workshops
- [From Data to Insights with {teal}](teal-framework.qmd) - Shiny framework
- [Getting Started with LLM APIs](../ai-llm/getting-started-llm-apis.qmd) - Another compute-heavy use case

### Next Steps
- **Build Shiny apps first:** [{teal} workshop](teal-framework.qmd)
- **Advanced Shiny:** [Validating Shiny Apps](../presentations/europe-us-sessions.qmd#validating-shiny-apps-in-regulated-environments)
