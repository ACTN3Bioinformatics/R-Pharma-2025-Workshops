...
<span class="badge badge-intermediate">Intermediate</span> <span class="badge badge-category">Shiny</span> <span class="badge badge-category">Interactive Apps</span>
...
<div class="tool-tag">{teal}</div>
<div class="tool-tag">{teal.modules.clinical}</div>
<div class="tool-tag">{teal.data}</div>
<div class="tool-tag">Shiny</div>
