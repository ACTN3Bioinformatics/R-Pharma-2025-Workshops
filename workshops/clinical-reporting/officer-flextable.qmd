...
-   📄 **Document structure** management in Word
-   📊 **Complex tables** following pharmaceutical standards
-   📈 **ggplot2 integration** for publication-ready figures
-   🎨 **Styling and formatting** for professional outputs
-   🔗 **Cross-references** and automated numbering
-   ✅ **Complete end-to-end** CSR generation
...
1.  **Tables not fitting page width** → Use `autofit()` or manual `width()` settings
2.  **Plots appear pixelated** → Increase DPI with `body_add_gg(width, height, res = 300)`
3.  **Cross-references not updating** → Right-click → "Update Field" in Word
4.  **Styles not applying** → Ensure template has required style definitions

## Integration with Other Tools

-   **{officedown}:** R Markdown → Word via officer
-   **{gtsummary}:** Statistical tables → flextable
...
### Similar Workshops
- [Cardinal: Clinical Reporting](cardinal-tlgs.qmd) - Standardized TLG templates
- [Branded Documents with Quarto](branded-quarto.qmd) - Alternative approach

### Related Presentations
- [autoslideR](../presentations/europe-us-sessions.qmd#autoslider-streamlining-slide-deck-generation) - Automated slide decks

### Next Steps
- **For tables:** See [Cardinal workshop](cardinal-tlgs.qmd)
- **For multi-format:** Try [Quarto workshop](branded-quarto.qmd)
- **Industry adoption:** [Automation trends](../summary/trends-insights.qmd#4-automation--efficiency-)
