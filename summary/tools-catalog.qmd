...
Use this catalog to: - Discover tools for your specific use case - Compare alternatives (e.g., {officer} vs Quarto for reports) - Identify dependencies (e.g., {gtsummary} uses {cards}) - Plan your learning path (prerequisites and related tools)
:::
